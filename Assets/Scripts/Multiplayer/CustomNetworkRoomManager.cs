...
public class CustomNetworkRoomManager : NetworkRoomManager
{
    ...
    public new static CustomNetworkRoomManager singleton => (CustomNetworkRoomManager)NetworkRoomManager.singleton;
    ...
    {
        gamePlayer.GetComponent<Player>().roomPlayer = roomPlayer.GetComponent<CustomNetworkRoomPlayer>();
    ...
    {
        if (roomManager != null && !roomManager.roomPlayer.readyToBegin)
    ...
    public override void OnRoomStartClient()
    {
        ...
        {
            case "RoomScene":
                roomManager.RoomSceneStart();
                break;
            case "GameplayScene":
                roomManager.GameSceneStart();
                break;
        }
    }
